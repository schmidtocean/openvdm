...
USAGE:  dpt_parser.py [-h] [-v+] [--timeFormat] [--startDT] [--stopDT] <dataFile>

DESCRIPTION:  Parse the supplied NMEA DPT file and return the json-formatted string
...
# RAW_COLS = ['date','time','hdr','depth','surface_offset','max-depth_checksum'] # SCS style
...
class DPTParser(OpenVDMCSVParser):
    """
...
if __name__ == "__main__":
    ...
    ovdm_parser = DPTParser(start_dt=parsed_args.startDT, stop_dt=parsed_args.stopDT, time_format=parsed_args.timeFormat)
