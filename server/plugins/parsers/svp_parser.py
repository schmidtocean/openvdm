...
USAGE:  svp_parser.py [-h] [-v+] [--timeFormat] [--startDT] [--stopDT] <dataFile>

DESCRIPTION:  Parse the supplied svp data and return the json-formatted
            ...
            with open(filepath, mode='r', encoding="utf-8") as csvfile:
                ...
                for lineno, line in enumerate(reader):
                    ...
                    try:
                        ...
                        sound_spd = float(line['sound_spd'])
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Parse SVP sensor data')
